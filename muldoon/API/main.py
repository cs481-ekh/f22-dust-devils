...
async def root(sol: str):
    ...
    val,val2 = getUrlValues(val)
    WSurl = 'https://pds-atmospheres.nmsu.edu/PDS/data/PDS4/Mars2020/mars2020_meda/data_derived_env/' + val2 + '/sol_' + val + '/WE__' + val + '___________DER_WS__________________P01.CSV'
    WSurl2 = 'https://pds-atmospheres.nmsu.edu/PDS/data/PDS4/Mars2020/mars2020_meda/data_derived_env/' + val2 + '/sol_' + val + '/WE__' + val + '___________DER_WS__________________P02.CSV'
